    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
                <form action="<?php
                echo 'Candidate/UpdateApplication?job-id='. $this->jobInfo['jID']
                ?>" method="post">
                    <div class="single-job-items mb-50">
                        ...
                        <div class="justify-content-end d-grid gap-4">
                            ...
                            <a href="<?php echo "Candidate/DeleteApplication?job-id=". $this->jobInfo["jID"]?>"
                               class="text-danger text-decoration-none fs-5">Delete Application</a>
                        </div>
                    </div>
                    <div class="job-post-details">
                        <div class="post-details2 mb-50">
                            <label for="appLetter" class="small-section-title form-label fs-4 fw-bold">Application For Job</label>
                            <textarea id="appLetter" class="form-control" rows="6" maxlength="400" name="appLetter" required autofocus><?php echo $this->applicationInfo["appLetter"]?></textarea>
                        </div>
                        <?php
                        if($this->applicationInfo["replyLetter"] != null && $this->applicationInfo["replyLetter"] != "") {
                            ...
                            <div class='post-details2 mb-50'>
                                ...
                                <p>
                                    <?php echo $this->applicationInfo['replyLetter']?>
                                </p>
                            </div>
                            ";
                        }
