...
<head>
    ...
    <title>Application Reply Edit Page</title>
</head>
<body>
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
                <form action="<?php
                echo 'Candidate/UpdateApplicationReply?candidate-id='. $this->candidateInfo['cID']. '&job-id='. $this->jobInfo['jID']
                ?>" method="post">
                    ...
                    <div class="job-post-details">
                        ...
                        <div class="post-details2 mb-50">
                            ...
                            <textarea id="replyLetter" class="form-control" rows="6" maxlength="400" name="replyLetter" required autofocus><?php echo $this->applicationInfo["replyLetter"]?></textarea>
                        </div>
                    </div>
                </form>
            </div>
